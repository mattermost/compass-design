/**
 * Storybook sidebar titles aligned with guidelines topic sections
...
export const TITLE_PROGRESS_PAGINATION_DOTS =
  'Components/Progress Indicators/Pagination Dots';
export const TITLE_PROGRESS_PROGRESS_BAR =
